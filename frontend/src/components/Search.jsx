...
const Search = ({ onSearch }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative border-white border-2 rounded-lg">
        ...
        <input
          type="search"
          id="default-search"
          className="block w-full p-4 ps-10 text-sm rounded-lg  focus:ring-blue-500 focus:border-blue-500 bg-transparent focus:bg-transparent "
          placeholder="Explore devs"
          required
          value={username}
